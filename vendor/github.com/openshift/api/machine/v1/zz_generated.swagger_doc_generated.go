...
var map_NutanixMachineProviderConfig = map[string]string{
	...
	"categories":        "categories optionally adds one or more prism categories (each with key and value) for the Machine's VM to associate with. All the category key and value pairs spcified must already exist in the prism central.",
